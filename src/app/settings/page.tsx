...
import { Settings, Key, ShieldCheck, Database, Check } from "lucide-react";
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Local API keys, database paths, and profile configuration settings.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-[10px] text-slate-500 mt-1">
                Stored strictly on your local disk in `.env.local`. Zero external key telemetry.
              </p>
            </div>
        ...
        {/* Database & Active Profile Context */}
        <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800/80 shadow-xl space-y-4">
          <div className="flex items-center gap-2 text-sm font-bold text-white pb-3 border-b border-slate-800">
          ...
          <div className="space-y-3 text-xs font-mono">
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-slate-950 border border-slate-800">
              <span className="text-slate-400">Master Resume PDF</span>
