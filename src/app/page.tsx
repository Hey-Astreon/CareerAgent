      ...
      <div className="p-3.5 rounded-xl bg-[#121215] border border-white/[0.08] space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-1.5 pt-1 border-t border-white/[0.06]">
          ...
          {[
            ...
            { id: "WORKABLE", label: `Workable (${platformCounts.WORKABLE || 0})` },
            { id: "SMARTRECRUITERS", label: `SmartRecruiters (${platformCounts.SMARTRECRUITERS || 0})` },
            { id: "RECRUITEE", label: `Recruitee (${platformCounts.RECRUITEE || 0})` },
            { id: "HIMALAYAS", label: `Himalayas (${platformCounts.HIMALAYAS || 0})` },
            { id: "REMOTIVE", label: `Remotive (${platformCounts.REMOTIVE || 0})` },
            { id: "HN_HIRING", label: `HN Hiring (${platformCounts.HN_HIRING || 0})` },
