    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800/80 shadow-2xl relative overflow-hidden backdrop-blur-xl">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1 max-w-2xl leading-relaxed">
              Monitoring <span className="text-slate-200 font-semibold">Greenhouse, Lever, Ashby, YC Work at a Startup, and LinkedIn Remote</span>. Showing postings ranked by age and low competition.
            </p>
          </div>
          ...
          >
            ...
            <span>{isScraping ? "Scraping Target ATS Feeds..." : "Run Multi-Platform Scrape"}</span>
          </button>
        </div>
        ...
        {activeProfile && (
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-5 pt-4 border-t border-slate-800/80">
            ...
            <div className="p-2.5 rounded-lg bg-slate-950/60 border border-slate-800/60">
              <div className="text-[10px] font-mono text-slate-400">Database Postings</div>
            ...
            <div className="p-2.5 rounded-lg bg-slate-950/60 border border-slate-800/60">
              <div className="text-[10px] font-mono text-slate-400">Discovery Engine</div>
      ...
      {isLoadingJobs ? (
        <div className="p-12 text-center text-slate-500 font-mono text-xs">
          Loading scraped job postings from SQLite database...
        </div>
      ) : filteredJobs.length === 0 ? (
        <div className="p-12 text-center rounded-2xl bg-slate-900/50 border border-slate-800/60 space-y-3">
          <p className="text-sm font-semibold text-slate-300">No scraped jobs found yet.</p>
          <p className="text-xs text-slate-400">Click "Run Multi-Platform Scrape" above to ingest live remote engineering roles.</p>
        </div>
      ) : (
