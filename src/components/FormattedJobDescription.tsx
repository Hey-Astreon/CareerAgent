...
export function FormattedJobDescription({ description, hasFullText, canFetchSourceText, onFetchSourceText }: FormattedJobDescriptionProps) {
  ...
  return <div className="ce-description space-y-4">
    ...
    <p className="text-[10px] leading-4 text-[var(--muted)]">{viewMode === "structured" ? "Structured view groups readable source text into practical sections. It does not add facts that are not in the source." : "Original source text preserves the readable source order and paragraph flow without RCMS grouping."}</p>
