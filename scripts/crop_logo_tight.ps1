...
Write-Host "Exact content bounds: X: $minX..$maxX (W: $($maxX - $minX)), Y: $minY..$maxY (H: $($maxY - $minY))"

# Minimal 6px padding around exact bounds
$pad = 6
